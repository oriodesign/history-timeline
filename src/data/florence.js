...
export const florence = {
    ...
    date: [846, 1859],
    timeline: [
        period("March of Tuscany", [846, 1197], "March_of_Tuscany"),
        period("Republic of Florence", [1115, 1532], "Republic_of_Florence"),
        period("Duchy of Florence", [1532, 1569], "Duchy_of_Florence"),
        period("Grand Duchy of Tuscany", [1569, 1801], "Grand_Duchy_of_Tuscany"),
        period("Kingdom of Etruria", [1801, 1807], "Kingdom_of_Etruria"),
        period("Grand Duchy of Tuscany", [1815, 1859], "Grand_Duchy_of_Tuscany"),
