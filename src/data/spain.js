...
export const spain = [
    ...
    state("Kingdom of Aragon", [1035, 1479], "Kingdom_of_Aragon", [
        ruler("Ramiro I", [1035, 1063], "Ramiro_I_of_Aragon"),
        ruler("Sancho Ramírez", [1063, 1094], "Sancho_Ram%C3%ADrez"),
        ruler("Peter I", [1094, 1104], "Peter_I_of_Aragon"),
        ruler("Alfonso I the Battler", [1104, 1134], "Alfonso_I_of_Aragon", '★'),
        ruler("Ramiro II the Monk", [1134, 1137], "Ramiro_II_of_Aragon"),
        ruler("Petronilla", [1137, 1164], "Petronilla_of_Aragon"),
        ruler("Alfonso II", [1164, 1196], "Alfonso_II_of_Aragon"),
        ruler("Peter II", [1196, 1213], "Peter_II_of_Aragon"),
        ruler("James I", [1213, 1276], "James_I_of_Aragon"),
        ruler("Peter III", [1276, 1285], "Peter_III_of_Aragon"),
        ruler("Alfonso III", [1285, 1291], "Alfonso_III_of_Aragon"),
        ruler("James II", [1291, 1327], "James_II_of_Aragon"),
        ruler("Alfonso IV", [1327, 1336], "Alfonso_IV_of_Aragon"),
        ruler("Peter IV", [1336, 1387], "Peter_IV_of_Aragon"),
        ruler("John I", [1387, 1396], "John_I_of_Aragon"),
        ruler("Martin", [1396, 1410], "Martin_I_of_Aragon"),
        ruler("Ferdinand I the Honest", [1412, 1416], "Ferdinand_I_of_Aragon"),
        ruler("Alfonso V the Magnanimous", [1416, 1458], "Alfonso_V_of_Aragon"),
        ruler("John II the Great", [1458, 1479], "John_II_of_Aragon")
    ]),
